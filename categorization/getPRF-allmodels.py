...
models = ["PMF", "wordvec-avg", "bow-tfidf", "weight-update-epoch10", "weight-update-epoch20", "weight-update-epoch50", "weight-update-epoch80", "weight-update-epoch100", 
		...
		"weight-update-epoch150-lr001-K150", "weight-update-epoch150-win3", "weight-update-epoch150-win4", "weight-update-epoch150-K50-win3", "weight-update-epoch150-K50-win4", "weight-update-epoch150-K150-win3", "weight-update-epoch150-K150-win4", 
		"lsi-tfidf-100", "lsi-tfidf-200"]
...
for root, dirs, files in os.walk(dataset_output_directory):
	break;
