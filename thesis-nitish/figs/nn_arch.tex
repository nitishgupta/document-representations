...
\begin{tikzpicture}[shorten >=1pt,->,draw=black!50, node distance=\layersep,transform shape,rotate=90]  %<-- rotate the NN
	...
	\newcommand{\inputsep}{1.5}
	\newcommand{\docnodey}{0}
	\newcommand{\docinputsep}{2.0}
	\newcommand{\docmiddlesep}{3.5}
	...
	%Doc 
	\node[pin=left:\rotatebox{-90}{\word{Rolling\\Stones}}] (I-1) at (-\wordneuron,\docnodey) {};
    ...
    % Annotate the layers
    \node[annot,above of=P-1, node distance=7.5cm,hoz] (hl) {\footnotesize Projection layer};
